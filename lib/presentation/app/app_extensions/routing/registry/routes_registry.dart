...
class MyAppRoutesRegistry {
  ...
  static List<AutoRoute> routes = <AutoRoute>[
    AdaptiveRoute(path: MyAppPathsRegistry.splash, page: SplashRoute.page),
    AdaptiveRoute(path: MyAppPathsRegistry.home, page: HomeRoute.page),
    AdaptiveRoute(path: MyAppPathsRegistry.game, page: GameRoute.page),
    // CustomRoute(
